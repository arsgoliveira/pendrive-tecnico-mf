...
$FerramentasMap = @{
    ...
    "memtest"         = @{ arquivo="MemTest86\memtest86.exe";          winget="";                                url="https://www.memtest86.com/download.htm" }
    ...
    "ipscanner"       = @{ arquivo="IPScanner\ipscan.exe";             winget="";                                url="https://www.advanced-ip-scanner.com" }
}
